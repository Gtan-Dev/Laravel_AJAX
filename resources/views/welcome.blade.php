...
<body class="flex justify-center items-center h-[100vh] bg-slate-400">

    <div class="bg-slate-700 rounded-xl shadow p-10 w-1/3">
        <h1 class="text-white text-3xl">AJAX to Display Districts within the provinces</h1>

        <div class="my-6">
            <select id="province-selector"
                class="py-1 w-full bg-slate-500 rounded border border-slate-700 text-white">
